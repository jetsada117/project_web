...
<div class="container container-custom9">
    <div class="box11 w-75">
        <h4>ความคิดเห็น (1 รายการ)</h4>
        <p class="text-muted">ต่อจากช่องแสดงความคิดเห็น</p>
        <div class="comment-box11">
            <p>ความคิดเห็นที่ 1: </p>
        </div>
        <button class="btn btn-back">กลับ</button>
    </div>
</div>
