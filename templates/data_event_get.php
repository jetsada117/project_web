    ...
    <div class="row d-flex justify-content-center align-items-center mt-3 w-100">
        ...
        <div class="col-md-5">
            <div class="cardcontent">
                ...
                <p><strong>ผู้สร้าง: </strong><?php echo htmlspecialchars($user['user_name']) ?></p>
                <p><strong>Email: </strong><?php echo htmlspecialchars($user['email']) ?></p>
                <p><strong>เบอร์: </strong><?php echo htmlspecialchars($user['phone']) ?></p>
            </div>
            <a href="/user_data?uid=<?= $user['uid'];?>">
                <button class="btn btn-danger btn-custom">ย้อนกลับ</button>
            </a>
        </div>
    </div>
</div>